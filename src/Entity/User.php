...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?int $panierActifId = null;
    ...
    public function getPanierActifId(): ?int
    {
        return $this->panierActifId;
    }

    public function setPanierActifId(?int $panierActifId): static
    {
        $this->panierActifId = $panierActifId;
